...
import { SmartLanding } from "../../../[truckId]/SmartLanding";
...
export default function SEOPage({
  ...
  // Fetch truck by slug
  const truck = useQuery(api.foodTrucks.getTruckBySlug, {
    state: params.state,
    city: params.city,
    slug: params.slug,
  });
  ...
  const items = useQuery(api.menu.getAllMenuItemsByTruck, truckId ? { truckId } : "skip") as any[] | undefined;
